...
def get_parser():
    ...
    parser = argparse.ArgumentParser(
        description=f"Framex CLI {__version__}", formatter_class=formatter, color=False,
    )
    ...
    get_parser = subparsers.add_parser(
        "get", help="Get dataset(s)", formatter_class=formatter
    )
    ...
    info_parser = subparsers.add_parser(
        "about", help="Info about dataset(s)", formatter_class=formatter
    )
    info_parser.add_argument("datasets", nargs="+", help="Info about dataset(s)")
    # "list" subparsers
    list_parser = subparsers.add_parser(
        "list", help="List available datasets", formatter_class=formatter
    )
